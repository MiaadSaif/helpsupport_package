...
Route::middleware(['web', 'change_password'])->group(function () {
   ...
   // Route::post('/TicketTracking', [HelpsupportController::class, 'TicketTracking'])->name('TicketTrackingPost');
    Route::post('/ViewResponse/TicketTracking', [HelpsupportController::class, 'TicketTracking'])->name('TicketTracking');
